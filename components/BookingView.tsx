...
export const BookingView: React.FC<BookingViewProps> = ({ onBack, onAddNotification }) => {
  ...
  // Cập nhật mã số: TT - NgàyTháng - Giờ - Số ngẫu nhiên (1-100)
  ...
  const downloadTicketAsImage = () => {
    ...
    drawSection('Khung giờ làm việc', formData.time, infoY, '#ffffff', 44, false);
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col items-center p-6 text-center">
          ...
          <div className="pt-4 space-y-3 shrink-0">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-yellow-100/40 font-bold uppercase tracking-[0.2em]">Phiếu hẹn điện tử đã được lưu trữ</p>
            </div>
          </div>
            ...
            <div className="space-y-6">
               <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold text-yellow-100/60">CCCD: {formData.cccd}</p>
                  </div>
